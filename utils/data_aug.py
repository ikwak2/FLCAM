...
# 0: no aug, 1: same aug below teacher&student, 2: different aug below teacher&student
...
def filt_aug(features, db_range=[-6, 6], n_band=[3, 6], min_bw=6, filter_type="linear"):
    ...
    n_freq_band = torch.randint(low=n_band[0], high=n_band[1], size=(1,)).item()   # [low, high)  # [2,5]
    if n_freq_band > 1:
